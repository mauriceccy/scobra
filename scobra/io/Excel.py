...
def ReadExcel(excel_file, parse="cobra_string", Print=False):
    ...
    cobra_reaction_position = ['Abbreviation','Description','Reaction','GPR','Genes','Proteins','Subsystem','Reversible','Lower bound','Upper bound','Objective','Confidence Score','EC Number','Notes','References','Rate Constant', 'Rate Equation', 'Exchange Reaction']
